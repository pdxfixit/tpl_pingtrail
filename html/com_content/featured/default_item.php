    ...
    <div class="rt-article"><div class="rt-article-bg">
            ...
            if ($this->item->images) {
                ...
                if ($introimages->float_intro) {
                    $intro_image_float = ' style="float:' . $introimages->float_intro . ';"';
                    if ($introimages->float_intro != "none") {
                        $intro_image_clear = '<div style="clear:' . $introimages->float_intro . ';"></div>';
                    }
                }
                ?>
                <div class="image-intro"<?php echo $intro_image_float; ?>>
                    <?php echo '<img src="' . $introimages->image_intro . '" alt="' . $introimages->image_intro_alt . '"/>'; ?>
                </div>
                <?php
                /** End Article Intro Image * */
            }
            ?>
            ...
            <?php echo $intro_image_clear . $this->item->introtext; ?>
